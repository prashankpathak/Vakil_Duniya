  ...
  return (
    <header className="h-20 px-4 sm:px-6 lg:px-12 flex flex-col justify-center border-b border-white/10 z-50 bg-black shrink-0 sticky top-0">
      <div className="flex items-center justify-between bg-black">
        ...
        {/* Desktop Navigation */}
        <nav className="hidden lg:flex gap-8 text-sm font-medium uppercase tracking-widest text-gray-400 items-center">
          {navLinks.map((link) => (
            <button
              key={link.id}
          ...
          <div className="flex items-center gap-3">
            ...
            {user ? (
              <div className="relative">
                <button
                  ...
                  className="flex items-center gap-2 bg-[#141414] hover:bg-[#1f1f1f] border border-[#c5a059]/40 text-white px-3.5 py-1.5 rounded-full text-xs font-semibold uppercase tracking-wider transition-all"
                >
              ...
              <button
                ...
                className="px-4 py-2 bg-[#c5a059] text-black text-xs font-bold uppercase tracking-widest hover:brightness-110 transition-all rounded whitespace-nowrap flex items-center gap-1.5"
              >
            ...
            <button
               ...
               className="px-4 py-2 border border-[#c5a059]/40 text-[#c5a059] text-xs font-bold uppercase tracking-widest hover:bg-[#c5a059] hover:text-black transition-all whitespace-nowrap rounded flex items-center gap-1.5"
            >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="lg:hidden border-t border-white/10 bg-black absolute w-full left-0 top-20 shadow-2xl overflow-y-auto z-50 pb-8"
          >
            ...
            <div className="p-4 bg-[#111] border-b border-white/5 flex items-center justify-between">
              {user ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-gray-400">Guest Client</span>
                </div>
              )}
              ...
              {user ? (
                <button
                  ...
                  className="text-[10px] uppercase font-bold text-red-400 bg-red-500/10 px-2.5 py-1 rounded"
                >
                  Logout
                </button>
              ) : (
                <button
                  ...
                  className="text-[10px] uppercase font-bold text-black bg-[#c5a059] px-3 py-1 rounded"
                >
                  Sign In
                </button>
              )}
              ...
              <div className="px-4 mt-6 mb-2 space-y-3">
                {!user && (
                  <button
                    ...
                    className="w-full px-6 py-3.5 bg-[#c5a059] text-black text-xs font-bold uppercase tracking-widest hover:brightness-110 transition-all text-center rounded"
                  >
                    Sign In / Register
                  </button>
                )}
                <button
                   ...
                   className="w-full px-6 py-3.5 border border-[#c5a059] text-[#c5a059] text-xs font-bold uppercase tracking-widest hover:bg-[#c5a059] hover:text-black transition-all text-center rounded flex items-center justify-center gap-2"
                >
                ...
                <button
                   ...
                   className="w-full px-6 py-3.5 border border-white/10 text-gray-400 text-xs font-bold uppercase tracking-widest hover:bg-white/10 hover:text-white transition-all text-center rounded"
                >
                  Owner Portal
                </button>
              </div>
